    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ Route::is('karyawan*') ? 'active' : '' }}">
                    <a href="#" class="sidebar-link">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item">
                            <a href="/data-riwayat">Data Riwayat</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item has-sub {{ Route::is('user*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="/data-user">Data Admin</a>
                        </li>
                        <li class="submenu-item">
                            <a href="/add-user">Tambah Admin</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                    <form action="/logout" method="POST">
                        @csrf
                        <button type="submit" class='sidebar-link ' style="border: none;background: transparent">
